      ...
      <>
        <div>
          <main className="text-gray-900">
            <section className="pt-18 md:pt-40">
              <div className="container mx-auto px-8 lg:flex">
                <div className="text-center lg:text-left lg:w-1/2">
                  ...
                  <p className="text-xl lg:text-2xl mt-6 font-light">
                    Trade bitcoin and other crypto with confidence on the
                  ...
                  <p className="mt-8 md:mt-12">
                    <Link to={"/signup"}>
                      <button
                        type="button"
                        className=" py-4 px-12 bg-blue-800 hover:bg-blue-700 rounded text-white"
                      >
                        Get Started
                      </button>
                    </Link>
                ...
                <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                  <div className="flex-1 px-3">
                    ...
                    >
                      ...
                      <p className="mt-4">
                        Buy crypto Buy BTC, ETH, and other crypto easily via
                        bank transfer. Price Alerts Be notified on BTC, ETH, XRP
                        prices, and more.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 px-3">
                    ...
                    >
                      ...
                      <p className="mt-4">
                        Recurring Buy Grow your portfolio automatically with
                        daily, weekly, or monthly trades. Buy crypto Buy BTC,
                        ETH, and other crypto easily via bank transfer.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:w-1/2">
                  <div className="lg:pr-32 xl:pr-48">
                    ...
                    <p className="mt-8 text-xl font-light leading-relaxed">
                      Our team of enthusiastic marketers will analyse and
